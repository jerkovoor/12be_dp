...
void CQvalue_Fit(){
    ...
    TF1* voigt4 = new TF1("voigt4",voig4,-10,10,20);
    ...
    */
    ...
    voigt4->SetParLimits (1,-4.2,-4.1); //( 1,-4.18,-4.05);//centroid of first gaussian and lorentzian
    ...
    voigt4->SetParLimits (7,0.001,0.05);//Amplitude of second lorentzian
    voigt4->SetParLimits (8,0.1,0.5);//width of second lorentzian
    //voigt4->SetParLimits (9,0.01,10);//Amplitude of third gaussian
    voigt4->SetParLimits (10,-2.7,-2.6);//centroid of third gaussian and lorentzian
    //voigt4->SetParLimits (11,0.01,0.05);//Amplitude of third lorentzian
    voigt4->SetParLimits (12,0.01,0.6);//width of third lorentzian
	voigt4->SetParLimits (13,0.01,0.05);//Amplitude of fourth gaussian
    voigt4->SetParLimits (14,-2.4,-2.2);//centroid of fourth gaussian and lorentzian
    voigt4->SetParLimits (16,0.01,0.3);//width of fourth lorentzian
    voigt4->SetParLimits (17,0.01,0.6);//voigt fraction
    ...
    TF1* voigt1b = new TF1("voigt1b",voig1,-3.4,-2.8,6);
    voigt1b->SetParameters(voigt4->GetParameter(5),voigt4->GetParameter(6),voigt4->GetParameter(2),voigt4->GetParameter(7),voigt4->GetParameter(8),voigt4->GetParameter(17));
    TF1* voigt1c = new TF1("voigt1c",voig1,-2.9,-2.55,6);
    voigt1c->SetParameters(voigt4->GetParameter(9),voigt4->GetParameter(10),voigt4->GetParameter(2),voigt4->GetParameter(11),voigt4->GetParameter(12),voigt4->GetParameter(17));
    TF1* voigt1d = new TF1("voigt1d",voig1,-2.5,-2.1,6);
    voigt1d->SetParameters(voigt4->GetParameter(13),voigt4->GetParameter(14),voigt4->GetParameter(2),voigt4->GetParameter(15),voigt4->GetParameter(16),voigt4->GetParameter(17));
