...
void lossfit(){
	...
	for(int i=0;i<16;i++){
		ifstream test;
		string f_name=Form("/mnt/c/Users/Jerome/OneDrive/Work/12Be/elast/outputs/out_60sum_%i_1H.dat",i);
	...
	ofstream bor;
	bor.open ( "/home/jerome/12Be_exp/scripts/scripts/Energy_loss_data/B_Dead_layer/B_fitparameters.txt" );//change the path and the name of the file acordingly
	bor << "Ring	a		b		c\n";
	...
	ofstream alum;
	alum.open ( "/home/jerome/12Be_exp/scripts/scripts/Energy_loss_data/Al_Dead_layer/Al_fitparameters.txt" );//change the path and the name of the file acordingly
	alum << "Ring	d		e		f\n";
	...
	ofstream tar;
	tar.open ( "/home/jerome/12Be_exp/scripts/scripts/Energy_loss_data/Target/D2_fitparameters.txt" );//change the path and the name of the file acordingly
	tar << "Ring	g		h		k\n";
