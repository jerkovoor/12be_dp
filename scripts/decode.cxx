...
double decode ( int run_num ){
	...
	//string f_name = Form ( "/home/jerome/12Be_exp/Raw_root/Be_notarget/tree%i.root",run_num ); //open the raw root file you want to convert to the format used by my codes; put the correct path and file name
	string f_name = Form ( "/home/jerome/12Be_exp/Raw_root/12Be/tree%i.root",run_num );
	...
	//string fOut_name = Form ( "/home/jerome/12Be_exp/Analysis/Be_notarget/decodeBe_notarget_pedestal%i.root",run_num ); //Open the output file; put the correct path and file name
	//string fOut_name = Form ( "/home/jerome/12Be_exp/Analysis/Be/AlphaOnly/decode_Yupedestal_%i.root",run_num );
	string fOut_name = Form ( "/home/jerome/12Be_exp/Analysis/TRIUMF_DL/decodeBe_Yupedestal_TDL_%i.root",run_num );
	...
	Alpha_peaksYu.open ( "/home/jerome/12Be_exp/Analysis/TRIUMF_DL/Yu_pedestal_TDL_fit.txt" );
