...
double calAl(){
	...
	ifstream loss1;
	loss1.open("/home/jerome/12Be_exp/scripts/scripts/Energy_loss_data/Alpha_calibration/alphaT1.txt");
	if(loss1.is_open()){
		for(int i=0; i<16; i++){
			loss1 >> alpha_loss1[i];
		}
	...
	ifstream loss2;
	loss2.open("/home/jerome/12Be_exp/scripts/scripts/Energy_loss_data/Alpha_calibration/alphaT2.txt");
	if(loss2.is_open()){
		for(int i=0; i<16; i++){
			loss2 >> alpha_loss2[i];
		}
	...
	ifstream loss3;
	loss3.open("/home/jerome/12Be_exp/scripts/scripts/Energy_loss_data/Alpha_calibration/alphaT3.txt");
	if(loss3.is_open()){
		for(int i=0; i<16; i++){
			loss3 >> alpha_loss3[i];
		}
	...
	ofstream Alpha_cal;
	Alpha_cal.open("/home/jerome/12Be_exp/Analysis/TRIUMF_DL/Yu_pedestal_TDL_fit.txt"); //open a .txt file to store the results of the fit; change the path and name acordingly
	...
	c1->Divide ( 4,4 ); //devide the Canvas in 16
		...
		TFile *f_out = new TFile("/home/jerome/12Be_exp/Analysis/TRIUMF_DL/Yu_pedestal_TDL_fit.root","RECREATE"); //create an output .root file; change the path and name acordingly
